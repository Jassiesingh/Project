class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        //enemy?
        this.enemy = new Enemy(this, 250, 200, 'Atlas1', 50, 'wandering50', 30).setTint(0xf0f0f0)
        ...
        for (let i = 0; i < 5; i++) {
            const e = new Enemy(this, 220 + 20 * i, 250, 'Atlas1', 10, 'wandering10', 30)
        ...
        if (projectile.active) {
            ...
            this.time.addEvent({
                ...
                callback: () => {
                    enemy.explode()
                    projectile.recycle()
                    // Projectiles.frameQuantity -= 1
                    // console.log(Projectiles.frameQuantity)
                },
                callbackScope: this,
                loop: false
            })
